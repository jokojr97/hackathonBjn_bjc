      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="alert alert-danger p-3" role="alert">
            <p>Pendaftaran Anda Belum Selesai!!! Jawab pertanyaan yang akan menentukan nilai Kepribadian Anda</p>
            <a href="<?= base_url('admin/pertanyaan') ?>" class="btn btn-danger">Selesaikan Pendaftaran</a>
          </div>
