    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-9">
          <br>
          <br>
          <div class="alert alert-success"> Skor Anda adalah <h1><?= $skor ?></h1></div>
          <a href="<?= base_url('admin/') ?>" class="btn btn-primary"><i class="fas fa-arrow-left"></i> Kembali ke Halaman Pekerjaan</a>
